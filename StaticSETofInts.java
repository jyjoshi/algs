 ...
 * <p>
 * For additional documentation, see <a href="https://algs4.cs.princeton.edu/12oop">Section 1.2</a>
 * of
...
public class StaticSETofInts {
    ...
    public static void main(String[] args) {
        int[] arr = { 1, 8, 8, 8, 9, 10 };
        StaticSETofInts x = new StaticSETofInts(arr);
        StdOut.print(x.howMany(8));
    }
